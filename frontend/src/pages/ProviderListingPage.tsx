...
const ProviderListingPage: React.FC = () => {
  ...
  const filteredProviders = serviceId 
    ? providers.filter(p => p.serviceId === serviceId)
    : providers;
            ...
            <div className="p-8 space-y-6 flex-grow flex flex-col">
              ...
              <div className="space-y-4 pt-6 border-t border-white/5 mt-auto">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-semibold">{provider.experience}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-[#4B5563] font-medium">Service</span>
                  <span className="text-white font-semibold">{provider.service}</span>
                </div>
                <Button 
                  size="full" 
